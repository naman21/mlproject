...
proc vTclWindow.top37 {base} {
    ...
    wm deiconify $top
    wm title $top "Classification"
    vTcl:DefineAlias "$top" "Toplevel1" vTcl:Toplevel:WidgetProc "" 1
    button $top.but38 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text {Load Train Data set} 
    ...
    listbox $top.lis42 \
        ...
        -selectforeground black -width 274 -listvariable clusterVar 
    ...
    label $top.lab49 \
        ...
        -text {Classification Algorithm Details} 
    ...
    label $top.lab51 \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -foreground {#000000} -text {Select algoirthm first} 
    vTcl:DefineAlias "$top.lab51" "Label5" vTcl:WidgetProc "Toplevel1" 1
    label $top.lab52 \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -foreground {#000000} -text {Select algorithm first} 
    ...
    button $top.but54 \
        ...
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 -text {Load Test Data set} 
    vTcl:DefineAlias "$top.but54" "Button4" vTcl:WidgetProc "Toplevel1" 1
    button $top.but55 \
        -activebackground {#d9d9d9} -activeforeground {#000000} \
        -background {#d9d9d9} -disabledforeground {#a3a3a3} \
        -foreground {#000000} -highlightbackground {#d9d9d9} \
        -highlightcolor black -pady 0 \
        -text {Load Ground Truth for Test Data set} 
    ...
    place $top.lis42 \
        -in $top -x 220 -y 130 -width 274 -relwidth 0 -height 118 \
        -relheight 0 -anchor nw -bordermode ignore 
    place $top.but56 \
        -in $top -x 620 -y 140 -anchor nw -bordermode ignore 
    place $top.lab49 \
        -in $top -x 50 -y 310 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 490 -y 310 -anchor nw -bordermode ignore 
    place $top.lab51 \
        -in $top -x 50 -y 370 -anchor nw -bordermode ignore 
    place $top.lab52 \
        -in $top -x 450 -y 370 -anchor nw -bordermode ignore 
    place $top.but53 \
        -in $top -x 530 -y 200 -width 66 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but54 \
        -in $top -x 220 -y 80 -width 136 -relwidth 0 -height 33 -relheight 0 \
        -anchor nw -bordermode ignore 
    place $top.but55 \
        -in $top -x 380 -y 80 -anchor nw -bordermode ignore 
